...
angular.module('myApp.view_form2', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_form2', {
            templateUrl: 'view_form2/view_form2.html',
            controller: 'FormView2Ctrl'
        });
    }])
    .controller('FormView2Ctrl', FormView2Ctrl);

function FormView2Ctrl($scope,FormDetailsService,UserDetailsService) {
