...
angular.module('myApp.edit_form1', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/edit_form1', {
            templateUrl: 'edit_form1/edit_form1.html',
            controller: 'EditForm1Ctrl'
        });
    }])
    .controller('EditForm1Ctrl', EditForm1Ctrl);

function EditForm1Ctrl($scope,FormDetailsService,ngNotify,UserDetailsService) {
